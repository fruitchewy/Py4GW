...
class NeverRampageAloneUtility(CustomSkillUtilityBase):
    def __init__(self,
    event_bus: EventBus,
    ...
    allowed_states: list[BehaviorState] = [BehaviorState.IN_AGGRO, BehaviorState.CLOSE_TO_AGGRO]
        ...
        super().__init__(
            event_bus=event_bus,
            skill=CustomSkill("Never_Rampage_Alone"),
    ...
    def _evaluate(self, current_state: BehaviorState, previously_attempted_skills: list[CustomSkill]) -> float | None:
        ...
        if Agent.IsAlive(pet) and buff_time_remaining <= self.renew_before_expiration_in_milliseconds: 
