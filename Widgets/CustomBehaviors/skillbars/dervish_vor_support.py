...
class DervishVor_UtilitySkillBar(CustomBehaviorBaseUtility):
    ...
    def __init__(self):
        ...
        #core
        self.vow_of_revolution_utility: CustomSkillUtilityBase = KeepSelfEffectUpUtility(event_bus=self.event_bus, skill=CustomSkill("Vow_of_Revolution"), current_build=in_game_build, score_definition=ScoreStaticDefinition(80), allowed_states=[BehaviorState.IN_AGGRO, BehaviorState.CLOSE_TO_AGGRO])
        ...
        self.imbue_health_utility: CustomSkillUtilityBase = ImbueHealthUtility(event_bus=self.event_bus, current_build=in_game_build, score_definition=ScorePerHealthGravityDefinition(10))

        #optional
        self.eremites_zeal_utility: CustomSkillUtilityBase = EremitesZealUtility(event_bus=self.event_bus, current_build=in_game_build, score_definition=ScoreStaticDefinition(70))
        ...
        self.great_dwarf_weapon_utility: CustomSkillUtilityBase = GreatDwarfWeaponUtility(event_bus=self.event_bus, current_build=in_game_build, score_definition=ScoreStaticDefinition(75))
    ...
    def skills_required_in_behavior(self) -> list[CustomSkill]:
        return [
            self.vow_of_revolution_utility.custom_skill
        ]
